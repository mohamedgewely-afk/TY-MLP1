...
export const createVehicleSlides = (
...
): VehicleSlide[] => [
  {
    ...
    icon: Gauge({ className: "h-5 w-5" }) as JSX.Element,
  ...
  },
  {
    ...
    icon: Shield({ className: "h-5 w-5" }) as JSX.Element,
  ...
  },
  {
    ...
    icon: Smartphone({ className: "h-5 w-5" }) as JSX.Element,
  ...
  },
  {
    ...
    image: galleryImages[1],
    icon: Wind({ className: "h-5 w-5" }) as JSX.Element,
  ...
  },
  {
    ...
    image: galleryImages[2],
    icon: Award({ className: "h-5 w-5" }) as JSX.Element,
  ...
  },
  {
    ...
    image: galleryImages[0],
    icon: PencilRuler({ className: "h-5 w-5" }) as JSX.Element,
