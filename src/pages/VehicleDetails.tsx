...
const VehicleDetails = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener(
      "openCarBuilder",
      handleOpenCarBuilder as EventListener
    );
    return () => {
  ...
  // ---- NEW: Experience Rail slides (model-agnostic, uses your existing state handlers) ----
  const slides: Slide[] = [
    {
      key: "performance",
      title: "Performance",
