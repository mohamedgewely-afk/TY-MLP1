      ...
      <div className="toyota-container">
                ...
                >
                  <div
                    className={`relative overflow-hidden rounded-xl transition-all duration-400 cursor-pointer group
                      ${active
                        ? "bg-white border-2 border-neutral-300 shadow-[0_6px_20px_rgba(0,0,0,0.05)]"
                        : "bg-white border border-neutral-200 hover:shadow-[0_6px_20px_rgba(0,0,0,0.05)]"
                      }`}
                    onClick={() => handleEngineChange(engine.name)}
                  >
                    {active && <div className="absolute inset-x-0 top-0 h-[2px] bg-gradient-to-r from-neutral-200 via-neutral-400 to-neutral-200" />}
        ...
        >
          ...
          <div className="relative max-w-4xl mx-auto">
            ...
            <button
              onClick={prevGrade}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-4 rounded-full bg-white border border-neutral-300 hover:bg-neutral-100 shadow-sm -translate-x-4 sm:-translate-x-6"
            ...
            <button
              onClick={nextGrade}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-2 sm:p-4 rounded-full bg-white border border-neutral-300 hover:bg-neutral-100 shadow-sm translate-x-4 sm:translate-x-6"
              style={{ minHeight: "36px", minWidth: "36px" }}
