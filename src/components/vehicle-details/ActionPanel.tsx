...
const ActionPanel: React.FC<ActionPanelProps> = ({
  ...
  className={[
    ...
    isGR
      ? "border-2 border-[#EB0A1E] text-[#EB0A1E] bg-carbon-pattern hover:bg-[#EB0A1E] hover:text-white"
      : "border-2 border-primary text-primary bg-white/50 hover:bg-primary hover:text-white"
  ].join(" ")}
>
