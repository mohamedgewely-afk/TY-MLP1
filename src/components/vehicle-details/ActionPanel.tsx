...
const ActionPanel: React.FC<ActionPanelProps> = ({
  ...
  return (
    ...
    >
      <div className="w-full max-w-[260px]  max-w-[2560px] mx-auto py-1.5 px-3 sm:px-4 lg:px-6 xl:px-8 2xl:px-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 2xl:grid-cols-12 gap-1 sm:gap-1.5">
          ...
          <motion.div 
            ...
            whileTap={{ scale: 0.98 }}
            className="col-span-2 sm:col-span-2 md:col-span-3 lg:col-span-3 xl:col-span-3 2xl:col-span-3 flex justify-center"
          >
            <Button 
              onClick={onBookTestDrive}
              className="w-full max-w-[260px]  bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground py-0.5 sm:py-1 lg:py-1.5 rounded-lg shadow-lg text-xs sm:text-sm"
              size="default"
            >
          ...
          >
            <Button 
              ...
              variant="outline"
              className="w-full max-w-[260px]  border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground py-0.5 sm:py-1 lg:py-1.5 rounded-lg bg-white/50 backdrop-blur-sm text-xs sm:text-sm"
              size="default"
            >
          ...
          >
            <Button 
              ...
              variant="outline"
              className="w-full max-w-[260px]  border border-gray-300 text-gray-700 hover:bg-gray-50 py-0.5 sm:py-1 lg:py-1.5 rounded-lg bg-white/50 backdrop-blur-sm text-xs sm:text-sm"
            >
          ...
          >
            <Button 
              onClick={handleShare}
              variant="outline"
              className="w-full max-w-[260px]  border border-gray-300 text-gray-700 hover:bg-gray-50 py-0.5 sm:py-1 lg:py-1.5 rounded-lg bg-white/50 backdrop-blur-sm"
            >
