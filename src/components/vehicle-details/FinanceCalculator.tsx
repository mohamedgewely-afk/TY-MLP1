...
const FinanceCalculator: React.FC<FinanceCalculatorProps> = ({ 
  ...
  const tabs = ["Standard Loan", "Balloon Payment", "Lease", "Islamic Finance"];
          ...
          <div className="p-6 text-center bg-gray-50 dark:bg-gray-700 rounded-lg">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Experience ethical financing that aligns with Islamic principles.
              </p>
      ...
      <AnimatePresence>
        ...
        >
          <div className="p-6">
            ...
            {/* Mobile Tab Navigation with Swipe */}
            {isMobile ? (
              <div className="mb-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-center">
                    <h3 className="font-semibold">{tabs[currentTab]}</h3>
                    <div className="flex space-x-2 mt-2">
                      {tabs.map((_, index) => (
                        <div
                          key={index}
                          className={`w-2 h-2 rounded-full transition-colors ${
                            index === currentTab ? 'bg-toyota-red' : 'bg-gray-300'
                          }`}
                        />
                      ))}
                    </div>
                ...
                {tabs.map((tab, index) => (
                  <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                      currentTab === index
                        ? 'bg-white shadow-sm text-toyota-red'
