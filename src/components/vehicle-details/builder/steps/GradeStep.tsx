...
const GradeStep: React.FC<GradeStepProps> = ({ config, setConfig }) => {
  return (
    <div className="p-6 pb-24 bg-gradient-to-b from-background to-muted/20">
      <motion.div 
        ...
        {grades.map((grade, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-background/50 to-muted/10 opacity-60" />
              ...
              <div className="relative z-10 flex items-center p-5">
                ...
                <div className="flex-shrink-0 mr-5">
                  <div className="w-20 h-20 rounded-xl overflow-hidden border-2 border-border/50 bg-muted/50">
                    <img
                      src={grade.image}
                      alt={grade.name}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <div className="text-lg font-bold text-foreground">{grade.price}</div>
      ...
      {/* Premium bottom spacing for mobile navigation */}
      <div className="h-6" />
    </div>
  );
};
