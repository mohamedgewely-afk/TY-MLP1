      ...
      <DialogContent className="max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              <option value="500">AED 500 - Hold Vehicle</option>
              <option value="1000">AED 1,000 - Standard Deposit</option>
              <option value="2000">AED 2,000 - Priority Reservation</option>
            </select>
          </div>
          ...
          <Button type="submit" className="w-full bg-brand-primary hover:bg-brand-primary/90">
            Reserve with AED {formData.depositAmount} Deposit
          </Button>
        </form>
      </DialogContent>
    </Dialog>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl lg:text-5xl font-light tracking-tight mb-4">
            Your Toyota Journey Starts Here
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Choose your next step and let us guide you through a seamless experience
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 text-sm text-muted-foreground">
            ...
            <div className="flex items-center">
              ...
              <span>Email: support@toyota.ae</span>
            </div>
            <div className="flex items-center">
